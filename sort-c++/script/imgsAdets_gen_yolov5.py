...
dir_imgs_out = '/home/manu/tmp/imgs_track'
path_det_out = '/home/manu/tmp/det.txt'
...
os.system('rm %s -rvf' % path_det_out)
os.system('rm %s -rvf' % dir_imgs_out)
os.mkdir(dir_imgs_out)
...
while cap.isOpened():
    ...
    idx_f_o = idx_f - idx_f_s + 1

    path_img_w = os.path.join(dir_imgs_out, '%06d.jpg' % idx_f_o)
    cv2.imwrite(path_img_w, frame)
    ...
    if det is not None:
        ...
        for d in det:
            ...
            line = '%d,-1,%f,%f,%f,%f,%f,-1,-1,-1\n' % (idx_f_o, box[0], box[1], box[2]-box[0], box[3]-box[1], d[4])
            fh.write(line)
            print(line)
